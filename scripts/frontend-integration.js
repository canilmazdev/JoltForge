 ...
 * This file demonstrates how to integrate Joltforge with a web frontend
 */

// For React/Vue/Angular applications
export class JoltforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new JoltforgeClient(provider, contractAddress);
